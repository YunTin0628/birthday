...
destinations = [
    {
        ...
        "album": [
            {
                "image": "images/1.png",
                "desc": "一開始我們是透過這隻企鵝認識的，沒想到他竟然變成我們愛情的起點。當時的我怎麼樣也沒想到這麼可愛的女孩未來會變成我最喜歡的人。謝謝你願意一直陪我聊很多事情，也陪我走過了那段難熬的時間。"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "album": [
            ...
            {
                "image": "images/14.jpg",
                "desc": "當時我們逛了市集，還一起打彈珠，差點打到不用回家好好笑，你還成功套到三瓶飲料，打敗我這個從小玩到大的，令人慚愧。"
            },
            {
                "image": "images/16.jpg",
                "desc": "韋禮安應該不會告我肖像權吧"
    ...
    },
    {
        ...
        "album": [
            {
                "image": "images/19.jpg",
                "desc": "終於我考完試了，於是我們一起去台中玩，不管是吃咖哩，逛草悟道，或是在一中街隨便逛，只要跟你待在一起就都很美好。"
            },
            {
                "image": "images/20.jpg",
                "desc": "我也買了很多帥帥的衣服，寶貝的眼光真棒，也買了說了很久的情侶T，以後我們要很常一起穿出門喔。最後經歷了goshare事件，還好沒被收兩萬，真是幸好。"
            }
        ]
    },
    {
        ...
        "album": [
            ...
            {
                "image": "images/f2.jpg",
                "desc": "這趟旅程經歷了很多事情，不管是開心的或是難過的甚至是生氣的，但不管如何，我對你的愛只會隨著時間變多。"
            },
            {
                "image": "images/f3.jpg",
...
st.markdown("""
    ...
    /* ========================================================
       3. 導航列：【完美同一排，頁碼縮小至 20px】
       ======================================================== */
    /* 讓裝有按鈕的橫向區塊，寬度剛好包住內容 (fit-content)，並且整體置中 */
    div[data-testid="stHorizontalBlock"] {
        ...
        justify-content: center !important;
        align-items: center !important;
        width: fit-content !important; /* 不允許撐滿 100% 螢幕 */
        max-width: 160px !important;   /* 60 + 10 + 20 + 10 + 60 = 160，限制總寬度 */
        margin: 15px auto !important;  /* 整個區塊置中 */
        gap: 10px !important;          /* 三個元件之間的間距 */
        padding: 0 !important;
    }
    ...
    div[data-testid="stHorizontalBlock"] > div[data-testid="column"] {
        ...
        flex: 0 0 auto !important; /* 不准伸展、不准縮水 */
    ...
    div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] > button {
        ...
        height: 40px !important; /* 稍微扁一點的圓角矩形 */
        padding: 0 !important;
        margin: 0 !important;
        border-radius: 15px !important;
        display: flex !important;
...
def show_journey_step(index):
    ...
    if len(album) > 1:
        ...
        with c_info:
            # 移除了會干擾排版的 width，讓 CSS 控制
            st.markdown(f"<div style='text-align:center; color:#aaa; font-weight:bold; font-size:16px; white-space:nowrap;'>{current_photo_index + 1} / {len(album)}</div>", unsafe_allow_html=True)
